 ...
 * For example, upcase/downcase in Ruby, upper/lower in Python,
...
the length of the transformed string may be longer than the original. Can you find a string that satisfies this criteria?
...
//When applying UpperCase to "ß," 
//it becomes "SS," and when you apply toLowerCase to "SS," it becomes "ss," 
//which has a length of 2, longer than the original length of 1.